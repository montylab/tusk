...
const handleRemoveCategory = async (id: string) => {
	if (
		confirm(`Are you sure you want to delete the category? Any tasks using this category will remain, but without the color association.`)
	) {
...
<template>
	<div class="categories-manager">
		...
		<div class="list-section">
			...
			<draggable v-else v-model="localCategories" item-key="id" handle=".drag-handle" class="categories-list" ghost-class="ghost">
				<template #item="{ element }">
					<div class="category-item-card">
						...
						<div class="actions">
							<Button icon="pi pi-trash" severity="danger" text rounded @click="handleRemoveCategory(element.id)" title="Delete Category" />
						</div>
					</div>
				</template>
			</draggable>
